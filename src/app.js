...
var GameLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        if ("touched" in cc.sys.capabilities) {
    ...
    _onMouseDown: function (event) {console.log('in mouse down');
    ...
    _popCandy: function (column, row) {
        ...
        if (joinCandys.length <= 1) return;
        console.log('in pop candy');
        this.steps++;
        this.moving = true;
        ...
        this._checkSuccessdOrFail();
        
    },

    _checkSuccessdOrFail: function () {
    ...
    _generateNewCandy: function () {console.log('in generate new candy');
        var maxTime = 0;
