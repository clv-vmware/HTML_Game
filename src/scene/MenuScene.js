...
var MenuScene = cc.Scene.extend({
    ctor: function () {
        ...
        var move = cc.moveTo(1, cc.p(this._hero.width / 2 + 100, this._hero.y)).easing(cc.easeOut(2));
        ...
        this._playBtn.x = 700;
        this._playBtn.y = 350;
        this._aboutBtn = new cc.MenuItemImage("#welcome_aboutButton", "#welcome_aboutButton", this._about, this);
        ...
        var menu = new Menu(this,_playBtn, this._aboutBtn, soundButton);
        layer.addChild(menu);
        menu.x = menu.y = 0;
